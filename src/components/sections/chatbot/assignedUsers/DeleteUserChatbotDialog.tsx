...
import { useDeleteUserChatbotMutation } from '@/redux/features/assignedUser/assignedUser.api';

function DeleteUserChatbotDialog() {
  const modalConfig = useSelector((state: RootState) => state.modal);
  const dispatch = useDispatch();

  const [deleteChatbot] = useDeleteUserChatbotMutation();
...
export default DeleteUserChatbotDialog;
